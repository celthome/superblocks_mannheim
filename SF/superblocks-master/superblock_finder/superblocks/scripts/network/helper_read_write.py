...
def city_metadata(city, path_pop_data="C:/Users/maren/Documents/UniGeo/Master/SoSe2024/KlForscherguppe/Eggimann_code/data/pop_fb"):
    ...
    metadata = {
        ...
        'mannheim': {
            'data_type': 'GeoTif',
            'centroid_tuple': (8.466182, 49.487712),
            'path_raw_pop': os.path.join(path_pop_data),
            'crs': 32632},
        'munchen': {
            'data_type': 'GeoTif',
